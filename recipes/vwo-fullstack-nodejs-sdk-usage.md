---
title: Wingify FullStack Node.js SDK Usage
...
Launch the SDK by providing the fetched settingsFile. This will create Wingify SDK's client instance which would be used to call the activation and tracking APIs exposed by the SDK.
