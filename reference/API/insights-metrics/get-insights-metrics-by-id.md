...
```sh
curl --location 'https://app.wingify.com/api/v2/accounts/123456/insights-metrics?limit=25&offset=0&order=asc&status=running&startTime=1755030400&endTime=1758014340' \
--header 'accept: application/json, text/plain, */*' \
--header 'TOKEN: WINGIFY_API_TOKEN' \
--header 'Cookie: COOKIES_VALUE_HERE' 
```
