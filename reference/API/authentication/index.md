...
next:
  description: ''
---
VWO's API lets you interact with a user’s Wingify account and allows you to act on your user's behalf to perform multiple operations. To do so, your application first needs to request authorization from users.
