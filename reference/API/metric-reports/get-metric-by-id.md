...
api:
  file: api.json
  operationId: get_accounts{account_id}insights-metrics{metrics_report_id}
deprecated: false
hidden: true
link:
  new_tab: false
...
* **Method**: `GET`
* **URL**:`http://app.vwo.com/api/v2/accounts/{account_id}/insights-metrics/{metrics_report_id}`
