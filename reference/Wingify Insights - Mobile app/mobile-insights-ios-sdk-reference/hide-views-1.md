...
views.append(view2);
// .. and so on
WingifyInsights.hideViews(views : views);
OR
WingifyInsights.hideViews(views : [view1, view2]);



// or simply pass each view separately
WingifyInsights.hideView(view :view1)
WingifyInsights.hideView(view :view2)
// .. and so on
```
