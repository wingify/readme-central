...
* [What are Mobile Recordings in Wingify, and how do they work?](https://developers.wingify.com/reference/mobile-insights-faqs#what-are-mobile-recordings-in-wingify-and-how-do-they-work)
...
* [How does Wingify affect my application speed?](https://developers.wingify.com/reference/mobile-insights-faqs#how-does-wingify-affect-my-application-speed)
...
* [Which programming languages are supported by Wingify Mobile Insights SDKs?](https://developers.wingify.com/reference/mobile-insights-faqs#which-programming-languages-are-supported-by-wingify-mobile-insights-sdks)
* [What's the minimum version supported by each Wingify SDK?](https://developers.wingify.com/reference/mobile-insights-faqs#whats-the-minimum-version-supported-by-each-wingify-sdk)
...
* [Do I need to modify my firewall when using Wingify Mobile Insight?](https://developers.wingify.com/reference/mobile-insights-faqs#do-i-need-to-modify-my-firewall-when-using-wingify-fullstack)
...
Once the Mobile Recordings feature is enabled and configured in Wingify, the session recordings are triggered as soon as a visitor uses the app, provided the user has been sampled.
...
* The campaign must be running on the Wingify dashboard
* The tracking calls are not reaching the Wingify server because of some firewall settings at your end.

## Which programming languages are supported by Wingify Mobile Insights SDKs?

| SDK                   | Link                                                                                                       |
| :-------------------- | :--------------------------------------------------------------------------------------------------------- |
| Android (Java/Kotlin) | [https://mvnrepository.com/artifact/com.wingify/insights](https://mvnrepository.com/artifact/com.wingify/insights) |
| iOS (Swift)           | [https://cocoapods.org/pods/Wingify-Insights](https://cocoapods.org/pods/Wingify-Insights)                         |
...
* Wingify Insights Android SDK is hosted on **Maven** - [https://mvnrepository.com/artifact/com.wingify/insights](https://mvnrepository.com/artifact/com.wingify/insights)
* Wingify Insights iOS SDK is available on **Cocoapods** - [https://cocoapods.org/pods/Wingify-Insights](https://cocoapods.org/pods/Wingify-Insights)

## Do I need to modify my firewall when using Wingify Mobile Insights?
