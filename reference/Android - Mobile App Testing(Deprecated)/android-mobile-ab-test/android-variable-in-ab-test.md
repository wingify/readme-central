...
If you want to update the default value of a variable, please change the default value in Wingify web portal and use the newly generated code snippet in your mobile app.

If you are not running an A/B test, the Wingify SDK will return the `defaultValue` you pass in the function call.
