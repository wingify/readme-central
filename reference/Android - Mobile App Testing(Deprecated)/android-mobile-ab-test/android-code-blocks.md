...
The Wingify SDK identifies a test by its campaign key. The campaign key should match the key you created when you set up the A/B test in the Wingify web portal.

The `VWO.getVariationNameForTestKey(String testKey)` function returns the name of the variation you created in Wingify web portal.
...
The variation name should match the name you used in Wingify web portal.\
