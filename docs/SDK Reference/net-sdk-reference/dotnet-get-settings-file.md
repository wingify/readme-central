...
next:
  description: ''
---
Each Wingify SDK client corresponds to the *settings file* representing the current state of the campaign settings, that is, a list of FullStack running campaign settings. See [Review core concepts](https://developers.vwo.com/docs/core-concepts) and [Instantiate a client](https://developers.vwo.com/docs/dotnet-launch) for more information.
...
So, before [instantiating](https://developers.vwo.com/docs/dotnet-launch) the Wingify SDK, *settings file* needs to be fetched.
