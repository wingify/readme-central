...
So, before [instantiating](https://developers.vwo.com/docs/javascript-launch) the Wingify SDK, *settings file* needs to be fetched.
...
Returns a Promise which on success returns the *settings file* which helps in [Instantiating](https://developers.vwo.com/docs/javascript-launch) the Wingify SDK. This method handles any error in fetching the settings file. Please follow the best practices to ensure that your app is prevented from crashing.
...
You can use [polling](https://developers.vwo.com/docs/javascript-configure-polling) or [webhooks](https://developers.vwo.com/docs/javascript-configure-webhooks) to keep your settings-file up-to-date with the Wingify Application(changes you made in FullStack campaigns).
