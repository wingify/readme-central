...
next:
  description: ''
---
After successfully [instantiating](https://developers.vwo.com/docs/javascript-launch) a VWO class, *Activate API* activates a FullStack A/B test for a specified user for a running campaign.
