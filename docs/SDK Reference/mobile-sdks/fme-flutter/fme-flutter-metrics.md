...
[block:parameters]
{
  "data": {
    ...
    "1-0": "**context**  \n_Required_",
    "1-1": "String",
    "1-2": "Contains information about the current user, including a required unique identifier for each user. Read more about userContext [here](https://developers.vwo.com/v2/docs/fme-flutter-context) .",
    "2-0": "**eventProperties**  \n_Optional_",
    "2-1": "Object",
