...
const userContext: WingifyUserContext = { id: userId, customVariables: customVariables};
...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Unique user ID for the current user. 'id' is the only required property in userContext. This ID should be a unique identifier for the current user which you need to pass to Wingify. [Read more here](https://developers.vwo.com/v2/docs/user-id-management)  .
      </td>
    </tr>
