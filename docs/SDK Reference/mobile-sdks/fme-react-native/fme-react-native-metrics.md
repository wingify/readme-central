...
WingifyClient.trackEvent('event_name', userContext, eventProperties);
...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Contains information about the current user, including a required unique identifier for each user. Read more about userContext [here](https://developers.vwo.com/v2/docs/fme-react-native-context) .
      </td>
    </tr>

    <tr>
      <td>
        **eventProperties**<br />_Optional_
      </td>
