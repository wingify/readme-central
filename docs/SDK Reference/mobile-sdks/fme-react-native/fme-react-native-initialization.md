...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The level of logging to be used. For more details, please check - [Logger](https://developers.wingify.com/v3/docs/fme-react-native-logging)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        A prefix to be added to log messages. For more details, please check - [Logger](https://developers.wingify.com/v3/docs/fme-react-native-logging)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        A callback function that receives data which can be pushed to any external tool that you need to integrate with. For more details, please check - [Integrations](https://developers.wingify.com/v3/docs/fme-react-native-integrations)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Expiry time for cached settings in milliseconds. For more details, please check - [Cache Management](https://developers.wingify.com/v3/update/docs/cache-setting-expiry#/)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Minimum size of batch to upload. For more detail, please check - [Event Batching](https://developers.wingify.com/v3/update/docs/event-batching#/)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Batch upload time interval in milliseconds. For more detail, please check - [Event Batching](https://developers.wingify.com/v3/update/docs/event-batching#/)
      </td>
    </tr>
  </tbody>
</Table>
...
- Integration Callback: Use `Wingify.registerIntegrationCallback` to manage integration events. [Refer documentation](https://developers.wingify.com/v3/docs/fme-react-native-integrations)
- Log Callback: Use `Wingify.registerLogCallback` to capture and handle log events. [Refer documentation](https://developers.wingify.com/v3/docs/fme-react-native-logging)
