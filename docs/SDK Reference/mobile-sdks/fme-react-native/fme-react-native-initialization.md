...
- Integration Callback: Use `Wingify.registerIntegrationCallback` to manage integration events. [Refer documentation](https://developers.wingify.com/v2/docs/fme-react-native-integrations)
- Log Callback: Use `Wingify.registerLogCallback` to capture and handle log events. [Refer documentation](https://developers.wingify.com/v2/docs/fme-react-native-logging)
