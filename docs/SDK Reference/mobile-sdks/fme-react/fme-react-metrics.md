...
> 📘 Important Note
>
> * The event name and properties sent via the  ***trackEvent*** hook must correspond exactly to the custom events defined in Wingify’s Data360 module.
...
* When the trackEvent() function is invoked:
  ...
  * If all validations pass:
    * Sends the event to Wingify via vwoClient.trackEvent(), including eventProperties if provided.
...
* Side Effects:
  * Network call made to Wingify’s event ingestion endpoint when trackEvent() is called.
