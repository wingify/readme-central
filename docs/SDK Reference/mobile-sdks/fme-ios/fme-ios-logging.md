...
```swift
let options = WingifyInitOptions(sdkKey: sdkKey, accountId: accountId, logLevel: .info)
...
```swift
let options = WingifyInitOptions(sdkKey: sdkKey, accountId: accountId, logLevel: .info, logPrefix: "CUSTOM_LOG_PREFIX")
