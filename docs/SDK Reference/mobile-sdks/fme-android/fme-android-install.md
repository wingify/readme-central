...
To integrate FE SDK into your Android application, you first need to install the SDK through a package manager for Android. Wingify FE Android SDK can be installed using [maven](https://mvnrepository.com/artifact/com.wingify.sdk/wingify-fme-android-sdk).
