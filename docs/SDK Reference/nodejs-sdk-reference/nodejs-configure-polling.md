...
Another way to detect a change in the settings-file is by using Webhooks. Refer [Configure Webhooks](https://developers.wingify.com/docs/nodejs-configure-webhooks) to know about it.
