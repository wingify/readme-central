...
User Storage Service is optional while [instantiating](https://developers.vwo.com/docs/nodejs-launch) the Wingify SDK. However, to ensure sticky variation assignments, we recommend implementing one.
