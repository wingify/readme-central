...
Storage Service is optional while [instantiating](https://developers.wingify.com/v3/docs/fme-java-initialization) the Wingify SDK. However, to ensure sticky variation assignments, we recommend implementing it.
...
Storage Service should expose two methods: _get_ and _set_. Wingify uses these methods whenever there is a need to read or write from the storage service.
