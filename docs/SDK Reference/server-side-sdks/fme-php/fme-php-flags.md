...
1. Check if the feature is enabled for the user:<br />`isFeatureEnabled = flag.is_enabled()`
2. Retrieve associated feature variables (if configured):<br />`variableValue = flag.getVariable('variableKey')
...
$flag = $wingifyClient->getFlag(‘feature_key’, $userContext);
```
...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Contains information about the current user, including a required unique identifier for each user. Read more about userContext here.
      </td>
    </tr>
  </tbody>
</Table>
