...
Storage Service is optional while [instantiating](https://developers.wingify.com/docs/nodejs-launch) the VWO SDK. However, to ensure sticky variation assignments, we recommend implementing it.
