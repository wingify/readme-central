...
// The 'user_context' ensures the event is associated with the correct user.
 var trackResponse = vwoClient.TrackEvent("event-name", context);
...
var trackResponse = vwoClient.TrackEvent("event_name", context, eventProperties);
