...
Storage Service is optional while [instantiating](https://developers.wingify.com/v2/docs/fme-ruby-initialization) the Wingify SDK. However, to ensure sticky variation assignments, we recommend implementing it.
