...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        An optional logger object that defines the logging behavior. For more details, please check - [Logging](https://developers.wingify.com/v3/docs/fme-ruby-logging)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Storage Service, if required, can be implemented using this parameter. For more details, please check - [Storage Service](https://developers.wingify.com/v3/docs/fme-ruby-storage)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Customize retry behavior by passing a **retry\_config** in the init options. For more details, please check - [Retry Configuration](https://developers.wingify.com/v3/docs/fme-ruby-initialization#retry-configuration)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        A callback function that receives data which can be pushed to any external tool that you need to integrate with. For more details, please check - [Integrations](https://developers.wingify.com/v3/docs/fme-ruby-integrations)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Custom proxy URL for redirecting all SDK network requests through a proxy server. Please check - [Proxy URL](https://developers.wingify.com/v3/docs/fme-ruby-initialization#proxy-url)
      </td>
    </tr>
  </tbody>
</Table>
...
Please click [here](https://developers.wingify.com/v3/docs/fme-ruby-logging) for more advanced logger options.
...
Please click [here](https://developers.wingify.com/v3/docs/fme-ruby-storage)  to learn more about storage implementation.
...
Please click [here](https://developers.wingify.com/v3/docs/fme-ruby-integrations) to learn more about Integrations,.
...
Please click <Anchor target="_blank" href="https://developers.wingify.com/v3/docs/fme-ruby-proxy-url">here</Anchor> to learn more about Proxy URL.
