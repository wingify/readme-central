...
| **user_context**<br />_Required_ | Hash   | Contains information about the current user, including a required unique identifier for each user. Read more about userContext [here](https://developers.wingify.com/v2/docs/fme-ruby-context).                |
