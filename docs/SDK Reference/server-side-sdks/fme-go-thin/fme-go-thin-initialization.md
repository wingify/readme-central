...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        URL of your [Gateway Service](https://developers.wingify.com/v3/docs/gateway-service).
      </td>
    </tr>
  </tbody>
</Table>
...
Please note that all three parameters are mandatory for initializing the Go SDK. Make sure you have set up the Gateway Service before initializing the SDK. For more information on the Gateway Service, refer to our [Gateway Service documentation](https://developers.wingify.com/v3/docs/gateway-service).
