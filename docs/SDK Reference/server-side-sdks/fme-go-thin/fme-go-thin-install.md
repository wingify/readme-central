...
> 📘 Note
>
> The Go SDK requires the use of Wingify Gateway Service. Make sure to set up the Gateway Service before initializing the SDK. For more information, see our [Gateway Service documentation](https://developers.wingify.com/v3/docs/gateway-service).
