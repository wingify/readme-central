...
next:
  description: ''
---
After successfully [instantiating](https://developers.vwo.com/docs/ruby-launch) a Wingify class, *Activate API* activates a FullStack A/B test for a specified user for a running campaign.
