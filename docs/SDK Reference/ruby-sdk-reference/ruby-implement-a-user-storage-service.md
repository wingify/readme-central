...
User Storage Service is optional while [instantiating](https://developers.wingify.com/docs/ruby-launch) the Wingify SDK. However, to ensure sticky variation assignments, we recommend implementing one.
...
# Now use it to initiate Wingify client instance
