...
So, before [instantiating](https://developers.vwo.com/docs/php-launch) the Wingify SDK, *settings file* needs to be fetched.
...
Returns the *settings file* which helps in [Instantiating](https://developers.vwo.com/docs/php-launch) the Wingify SDK. This method handles any error in fetching the settings file. Please follow the best practices to ensure that your app is prevented from crashing.
