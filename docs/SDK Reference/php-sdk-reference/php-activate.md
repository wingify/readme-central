...
next:
  description: ''
---
After successfully [instantiating](https://developers.vwo.com/docs/php-launch) a VWO class, _Activate API_ activates a FullStack A/B test for a specified user for a running campaign.
