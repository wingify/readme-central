...
next:
  description: ''
---
After successfully [instantiating](https://developers.wingify.com/docs/python-launch) a Wingify class, *Activate API* activates a FullStack A/B test for a specified user for a running campaign.
...
The API method requires a campaign unique-key *campaign\_key* and a User ID - *userId*. You can also pass other flags in the *options* key. 
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        user\_agent(String): userAgent of the visitor  

        user\_ip\_address(String): IpAddress of the visitor
      </td>
    </tr>
  </tbody>
</Table>
