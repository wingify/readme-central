...
User Storage Service is optional while [instantiating](https://developers.vwo.com/docs/java-launch) the VWO SDK. However, to ensure sticky variation assignments, we recommend implementing one.
