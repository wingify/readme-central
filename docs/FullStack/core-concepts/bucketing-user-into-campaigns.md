...
next:
  description: ''
---
Once a user is [identified](https://developers.wingify.com/docs/identify-users) and assigned a unique identifier, that identifier should be used throughout the user's journey to experience a consistent behavior of an application.
