...
Wingify Web Testing automatically sets a first-party cookie named _vwo_uuid in the visitor's browser when the Wingify SmartCode loadscalled _vwo_uuid in the visitor's browser when the VWO SmartCode is loaded.
