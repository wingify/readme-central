...
2. [Initialization Performance](#initialization-performance)  - Learn about the startup behavior of the SDK and how it handles configuration loading.
3. [Method Benchmarks](#method-benchmarks)  - Dive into micro-benchmarks for common methods like getFlag, track, and others.
