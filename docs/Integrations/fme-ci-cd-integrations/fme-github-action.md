...
The following input fields need to be provided when using the `Wingify FE GitHub Action`.
...
| :------------------- | :-------------------------------------------------------------------------------------------------------------------- | :------- |
| **VWO\_SDK\_KEY**    | The SDK key is used to initialize the Wingify SDK. This key is required for the action to interact with the Wingify platform. | Yes      |
| **VWO\_ACCOUNT\_ID** | The account ID of the Wingify project. This ID is used to identify the Wingify account associated with the feature flags.     | Yes      |

You should store the `WINGIFY_SDK_KEY` and `WINGIFY_ACCOUNT_ID` securely in your GitHub repository’s secrets (e.g., `${{ secrets.WINGIFY_SDK_KEY }})`.
  ...
  feature-flag-evaluation:
    ...
    steps:
      - name: Evaluate Feature Flags
        ...
        env:
          WINGIFY_SDK_KEY: ${{ secrets.WINGIFY_SDK_KEY }}
          WINGIFY_ACCOUNT_ID: ${{ secrets.WINGIFY_ACCOUNT_ID }}
...
* The `Evaluate Feature Flags` step uses the `Wingify FE GitHub Action` to evaluate the feature flags for a user with the specified context (`userContext`).
...
* The Wingify SDK credentials (`WINGIFY_SDK_KEY` and `WINGIFY_ACCOUNT_ID`) are passed securely using GitHub secrets.
