...
This integration allows you to use Segment-computed traits and audiences for Wingify feature flag targeting. By importing these segments into Wingify, you can perform highly granular rollouts and A/B tests based on real-time user data captured across your entire tech stack.
...
* **Audience-driven A/B testing:** Combine Segment’s unified customer data with Wingify’s experimentation engine.
* **Data-driven decisions:** Leverage Segment’s rich cross-platform user data for more effective feature rollouts.

## **Step 1: Enabling the Wingify-Segment Integration for your Wingify Account**
...
## **Step 3: Import & Activate Segment Audiences in Wingify**
...
## **Step 5: Setting Up Pre-Segmentation in Wingify**
...
* **Wingify Cloud Mode (Actions):** This is the essential channel for transiting audience data from Segment to Wingify.
...
* **ID Mapping:** Ensure the key used in `customVariables` matches the identifier name defined in Wingify's rule configuration.
