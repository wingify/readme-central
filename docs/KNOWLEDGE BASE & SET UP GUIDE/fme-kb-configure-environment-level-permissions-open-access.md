...
metadata:
  robots: index
---
In, managing feature flag rules, such as enabling or disabling them, typically requires a user to have account-level Publish permissions. This standard security measure ensures that only authorized personnel can enable or disable rules. However, this can create a bottleneck for users or teams, who often have more restricted access levels (such as Design or Browse) and cannot test their changes without an administrator's assistance.
