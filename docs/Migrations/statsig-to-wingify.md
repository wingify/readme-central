...
1. Connect Wingify to your workspace.
2. Run the migration.
3. Use a single prompt in your IDE to recreate your flags, configs, and experiments in Wingify and update your application code.
